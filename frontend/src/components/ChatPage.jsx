...
import userAvatar from '../assets/img/user-avatar.png'; // Update to the correct path
import aiAvatar from '../assets/img/ai-avatar.png'; // Update to the correct path
import chatbotImage from '../assets/img/chatbot.jpeg'; // Update to the correct path
    ...
    <div className="chat-page">
      ...
      <div className="chat-right">
        <div className="chat-header">
          <h1>CompanionAI</h1>
          <Link to="/gender" className="voice-choice">
          Change Voice
        </Link>
        </div>
